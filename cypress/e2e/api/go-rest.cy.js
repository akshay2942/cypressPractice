...
// 16e42251ef4f21a75eb9895328bcd880da6553ed60d610766362e4e441148893
describe('verify the  Go rest  API', function () {

    it(' TC 01 verify the LIST User API', function () {

        cy.request({
            method: "GET",
            url: "https://gorest.co.in/public/v2/users",
            headers: {
                Authorization: `Bearer 16e42251ef4f21a75eb9895328bcd880da6553ed60d610766362e4e441148893`
            }
        }).then(function (res) {
            // cy.log(res)
    ...
    it(' TC 02 verify the CREATE User POST  API', function () {

        let payload = {
            name: "akshay kshirsagar",
            gender: "male",
            email: `akshay${Math.random()*6}.kshirsagar@sdm.com`,
            status: "active"
        }
        cy.request({
            method: "POST",
    ...
    it(' TC 03 verify the UPDATE( put ) User API', function () {
